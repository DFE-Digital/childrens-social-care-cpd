...
var options = new ApplicationInsightsServiceOptions { ConnectionString = Environment.GetEnvironmentVariable(SiteConstants.CPDINSTRUMENTATIONKEY ?? String.Empty) };
